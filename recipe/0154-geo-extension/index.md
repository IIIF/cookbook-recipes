...
### Use Case 
You would like to see your IIIF Presentation API 3.0 Manifest represented on open source world map based user interfaces such as Leaflet or Google Maps. This could mean simply displaying a geometric shape on a map, but may include more data from the resource in connection with the geometric shape to facilitate robust functionality within the MapUI.
